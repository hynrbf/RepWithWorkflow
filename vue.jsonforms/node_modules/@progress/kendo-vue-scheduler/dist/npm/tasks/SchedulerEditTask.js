...
exports.SchedulerEditTaskVue2 = exports.SchedulerEditTask = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var SchedulerEditTaskVue2 = {
  ...
  computed: {
    ...
    currentEditable: function currentEditable() {
      return (0, main_1.useEditable)(this.$props.editable);
    }
  },
  // @ts-ignore
  ...
  render: function render(createElement) {
    ...
    return (
      ...
      h(SchedulerViewTask_1.SchedulerViewTask, {
        id: this.$props.id,
  ...
  methods: {
    ...
    handleSeriesClick: function handleSeriesClick(event) {
      if (this.compRemoveItem) {
        ...
        var dataItem = (0, main_2.findMaster)(this.compRemoveItem, this.ks.fields, this.ks.dataItems);
...
exports.SchedulerEditTaskVue2 = SchedulerEditTaskVue2;
/**
 * @hidden
 */
var SchedulerEditTask = SchedulerEditTaskVue2;
exports.SchedulerEditTask = SchedulerEditTask;