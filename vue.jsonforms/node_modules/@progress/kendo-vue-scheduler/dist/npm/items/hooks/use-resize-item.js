...
exports.useResizeItem = exports.RESIZE_ITEM_ACTION = void 0;
...
var oldSlot = null;
/** @hidden */
var useResizeItem = function useResizeItem(action, event) {
  var _this = this;
    ...
    case RESIZE_ITEM_ACTION.start:
      {
        ...
        var slot = (0, main_1.slotDive)(clientX, clientY, 7);
        if (!slot) {
          return;
        }
        if (slot === oldSlot) {
        ...
        if (newStart >= (0, main_1.getField)(dataItem, this.ks.fields.end)) {
          return;
        }
        (0, main_1.setField)(dataItem, this.ks.fields.start, newStart);
        oldSlot = slot;
    ...
    case RESIZE_ITEM_ACTION.startDragSelected:
      {
        ...
        var slotStart = slot.getAttribute('data-slot-start');
        var itemStart = new Date((0, main_1.getField)(dataItem, this.ks.fields.start));
        var newStart = new Date(Number(slotStart));
        ...
        var newResizeItems = this.bv.selectedItems.map(function (si) {
          ...
          if (selectedStart >= (0, main_1.getField)(selectedDataItem, _this.ks.fields.end)) {
            unreachable_1 = true;
            return;
          }
          (0, main_1.setField)(selectedDataItem, _this.ks.fields.start, selectedStart);
    ...
    case RESIZE_ITEM_ACTION.endDrag:
      {
        ...
        (0, main_1.setField)(dataItem, this.ks.fields.end, newEnd);
        oldSlot = slot;
        newResizeItem = dataItem;
        break;
      }
    case RESIZE_ITEM_ACTION.endDragSelected:
      {
        ...
        var itemEnd = new Date((0, main_1.getField)(dataItem, this.ks.fields.end));
        var newEnd = new Date(Number(slotEnd));
        ...
        var newResizeItems = this.bv.selectedItems.map(function (si) {
          ...
          if (selectedEnd <= (0, main_1.getField)(selectedDataItem, _this.ks.fields.start)) {
            unreachable_2 = true;
            return;
          }
          (0, main_1.setField)(selectedDataItem, _this.ks.fields.end, selectedEnd);
          return selectedDataItem;
        }).filter(Boolean);
        if (!unreachable_2) {
          newResizeItem = __spreadArray([], newResizeItems, true);
    ...
    case RESIZE_ITEM_ACTION.completeSeries:
      {
        ...
        if (Array.isArray(this.compResizeItem)) {
          newDataItem = this.compResizeItem.map(function (item) {
            var newItem = (0, kendo_vue_common_1.clone)(item);
            (0, main_1.setField)(newItem, _this.ks.fields.start, (0, main_1.getField)(item, _this.ks.fields.start));
            (0, main_1.setField)(newItem, _this.ks.fields.end, (0, main_1.getField)(item, _this.ks.fields.end));
            return newItem;
          });
        } else {
          var newItem = (0, kendo_vue_common_1.clone)(this.compResizeItem);
          (0, main_1.setField)(newItem, this.ks.fields.start, (0, main_1.getField)(this.compResizeItem, this.ks.fields.start));
          (0, main_1.setField)(newItem, this.ks.fields.end, (0, main_1.getField)(this.compResizeItem, this.ks.fields.end));
          newDataItem = newItem;
        }
        if (newDataItem) {
          this.$emit('dataaction', {
...
exports.useResizeItem = useResizeItem;