...
exports.SchedulerItemVue2 = exports.SchedulerItem = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var SchedulerItemVue2 = {
  ...
  computed: {
    currentEditable: function currentEditable() {
      return (0, main_3.useEditable)(this.$props.editable);
    },
    resource: function resource() {
      ...
      var nonGroupedWithColor = (0, main_1.toSchedulerGroups)(undefined, this.ks.props.resources)[0].resources.find(function (r) {
    ...
    eventLabel: function eventLabel() {
      return "".concat((0, main_4.formatEventTime)(this.intl, this.$props.zonedStart, this.$props.zonedEnd, this.$props.isAllDay), ", ").concat(this.$props.title);
    },
  ...
  created: function created() {
    this.setItems({
      type: main_1.COLLECTION_ACTION.add,
      item: this
    });
  },
  ...
  render: function render(createElement) {
    ...
    var deleteMessage = localization.toLanguageString(main_2.deleteTitle, main_2.messages[main_2.deleteTitle]);
    ...
    return (
      ...
      h(kendo_vue_common_1.Draggable, {
        ...
        return [h("div", {
          ...
          attrs: _this2.v3 ? undefined : {
            name: _this2.ks.isRtl ? 'caret-alt-right' : 'caret-alt-left',
            icon: _this2.ks.isRtl ? kendo_svg_icons_1.caretAltRightIcon : kendo_svg_icons_1.caretAltLeftIcon,
            size: 'medium'
          },
          icon: _this2.ks.isRtl ? kendo_svg_icons_1.caretAltRightIcon : kendo_svg_icons_1.caretAltLeftIcon,
          size: 'medium'
        }), _this2.$props.isRecurring && !_this2.$props.isException && h(kendo_vue_common_1.Icon, {
          ...
          icon: kendo_svg_icons_1.xIcon,
          size: 'medium'
        })]), _this2.$props.head && h(kendo_vue_common_1.Icon, {
          name: _this2.ks.isRtl ? 'caret-alt-left' : 'caret-alt-right',
          attrs: _this2.v3 ? undefined : {
            name: _this2.ks.isRtl ? 'caret-alt-left' : 'caret-alt-right',
            icon: _this2.ks.isRtl ? kendo_svg_icons_1.caretAltLeftIcon : kendo_svg_icons_1.caretAltRightIcon,
            size: 'medium'
          },
          icon: _this2.ks.isRtl ? kendo_svg_icons_1.caretAltLeftIcon : kendo_svg_icons_1.caretAltRightIcon,
          size: 'medium'
...
exports.SchedulerItemVue2 = SchedulerItemVue2;
/**
 * @hidden
 */
