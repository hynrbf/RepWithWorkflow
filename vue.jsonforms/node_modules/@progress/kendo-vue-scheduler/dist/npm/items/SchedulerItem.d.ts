...
export interface SchedulerItemProps extends Item {
     ...
     * The SchedulerItem is using the [Kendo UI for VueDraggable]({% slug draggable_common %}) instead of the `onDragStart` callback.
     */
     ...
     *
     * This event is used by the [`Drag & Drop`]({% slug editing_scheduler %}) functionality of the SchedulerItem.
     * The SchedulerItem is using the [Kendo UI for VueDraggable]({% slug draggable_common %}) instead of the `onDrag` callback.
     */
     ...
     *
     * This event is used by the [`Drag & Drop`]({% slug editing_scheduler %}) functionality of the SchedulerItem.
     * The SchedulerItem is using the [Kendo UI for VueDraggable]({% slug draggable_common %}) instead of the `onDragEnd` callback.
     */
 ...
 * @hidden
 */
export interface SchedulerItemComputed {
    [key: string]: any;
}
/**
 * @hidden
 */
export interface SchedulerItemMethods {
    [key: string]: any;
}
/**
 * @hidden
 ...
 * @hidden
 */
export interface SchedulerItemAll extends Vue2type, SchedulerItemMethods, SchedulerItemData, SchedulerItemComputed, SchedulerItemState {
}
/**
 * @hidden
 */
declare let SchedulerItemVue2: ComponentOptions<SchedulerItemAll, DefaultData<SchedulerItemData>, DefaultMethods<SchedulerItemAll>, SchedulerItemComputed, RecordPropsDefinition<SchedulerItemProps>>;
/**
 * @hidden
 */
declare const SchedulerItem: DefineComponent<SchedulerItemProps, any, SchedulerItemData, SchedulerItemComputed, SchedulerItemMethods, {}, {}, {}, string, SchedulerItemProps, SchedulerItemProps, {}>;
