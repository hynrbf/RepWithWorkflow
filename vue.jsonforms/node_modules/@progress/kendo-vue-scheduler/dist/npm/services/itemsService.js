            ...
            if ((0, exports.inGroup)(occurrence, group)) {
                ranges.forEach(function (range) {
                    if ((0, exports.inRange)(occurrence, range)) {
                        ...
                        var item = __assign(__assign({}, occurrence), { refTo: refTo, itemRef: itemRef, head: head, tail: tail, order: null, zonedStart: zonedStart, zonedEnd: zonedEnd, group: group, range: range, slots: [], isRecurring: Boolean(occurrence.recurrenceRule), isException: Boolean(!occurrence.recurrenceRule
...
var inSlot = function (occurrence, slot) {
    return (0, main_1.intersects)(slot.start, slot.end, occurrence.start, occurrence.end);
};
exports.inSlot = inSlot;
/** @hidden */
var inRange = function (occurrence, range) {
    return (0, main_1.intersects)(range.start, range.end, occurrence.start, occurrence.end)
