...
var toOccurrences = function (data, _a) {
    ...
    var result = data
        ...
        .filter(function (occurrence) { return !(0, main_1.isMaster)(occurrence.dataItem, fields); });
    return result;
};
exports.toOccurrences = toOccurrences;
var readItem = function (fields) { return function (dataItem) {
    var result = {
        uid: (0, kendo_vue_common_1.getter)(fields.id || 'id')(dataItem),
        start: (0, kendo_vue_common_1.getter)(fields.start || 'start')(dataItem),
        startTimezone: (0, kendo_vue_common_1.getter)(fields.startTimezone || 'startTimezone')(dataItem),
        originalStart: (0, kendo_vue_common_1.getter)(fields.originalStart || 'originalStart')(dataItem),
        end: (0, kendo_vue_common_1.getter)(fields.end || 'end')(dataItem),
        endTimezone: (0, kendo_vue_common_1.getter)(fields.endTimezone || 'endTimezone')(dataItem),
        isAllDay: (0, kendo_vue_common_1.getter)(fields.isAllDay || 'isAllDay')(dataItem),
        title: (0, kendo_vue_common_1.getter)(fields.title || 'title')(dataItem),
        description: (0, kendo_vue_common_1.getter)(fields.description || 'description')(dataItem),
        occurrenceId: (0, kendo_vue_common_1.getter)('occurrenceId')(dataItem),
        recurrenceRule: (0, kendo_vue_common_1.getter)(fields.recurrenceRule || 'recurrenceRule')(dataItem),
        recurrenceExceptions: (0, kendo_vue_common_1.getter)(fields.recurrenceExceptions || 'recurrenceExceptions')(dataItem),
        recurrenceId: (0, kendo_vue_common_1.getter)(fields.recurrenceId || 'recurrenceId')(dataItem),
        dataItem: (0, kendo_vue_common_1.clone)(dataItem)
    };
    return result;
}; };
var occurrenceReducer = function (dateRange, timezone, fields) { return function (acc, current) {
    return __spreadArray(__spreadArray([], acc, true), ((Boolean(current.recurrenceRule)
        ...
        && (0, main_1.isMaster)(current.dataItem, fields))
...
var occurrences = function (item, _a) {
    ...
    var expanded = series.events.map(function (occurrence, idx) {
        var occurrenceItem = (0, kendo_vue_common_1.clone)(item);
        var occurrenceDataItem = (0, kendo_vue_common_1.clone)(item.dataItem);
        occurrenceItem.recurrenceId = occurrenceItem.uid;
        (0, main_1.setField)(occurrenceDataItem, fields.recurrenceId, item.uid);
        occurrenceItem.originalStart = occurrence.start.toLocalDate();
        (0, main_1.setField)(occurrenceDataItem, fields.originalStart, occurrence.start.toLocalDate());
        occurrenceItem.start = occurrence.start.toLocalDate();
        (0, main_1.setField)(occurrenceDataItem, fields.start, occurrence.start.toLocalDate());
        occurrenceItem.end = occurrence.end.toLocalDate();
        (0, main_1.setField)(occurrenceDataItem, fields.end, occurrence.end.toLocalDate());
        occurrenceItem.occurrenceId = String(idx);
        (0, main_1.setField)(occurrenceDataItem, 'occurrenceId', String(idx));
