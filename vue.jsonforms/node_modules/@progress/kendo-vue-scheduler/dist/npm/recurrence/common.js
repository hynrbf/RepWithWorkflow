...
var getFrequency = function (rrule) {
    if ((0, main_1.isPresent)(rrule) && !(0, main_1.isNullOrEmptyString)(rrule.freq)) {
        return rrule.freq;
    }
    return 'never';
};
...
var getUntil = function (rrule) {
    if ((0, main_1.isPresent)(rrule.until)) {
...
var getWeekDay = function (weekDays, rrule, start) {
    return weekDays.find(function (item) {
        var value;
        if ((0, main_1.isPresent)(rrule.byWeekDay)) {
...
var getEndRule = function (rrule) {
    if ((0, main_1.isPresent)(rrule.count)) {
        return 'count';
    }
    else if ((0, main_1.isPresent)(rrule.until)) {
        return 'until';
    }
    else {
        return 'never';
...
var getRepeatOnRule = function (rrule) {
    ...
    else if ((0, main_1.isPresent)(rrule.byMonthDay)) {
        return 'monthday';
    }
};
...
var getMonthDay = function (rrule, start) {
    if ((0, main_1.isPresent)(rrule.byMonthDay) && rrule.byMonthDay.length > 0) {
...
var getUntilEnd = function (start, until) {
    ...
    if ((0, main_1.isPresent)(currentUntil)) {
        return currentUntil;
    }
    else {
...
var getUntilMin = function (start, until) {
    var currentStart = start;
    var currentUntil = until;
    if ((0, main_1.isPresent)(currentUntil) && currentUntil < currentStart) {
        return currentUntil;
    }
    else {
        return currentStart;
