...
exports.SchedulerSlotVue2 = exports.SchedulerSlot = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var SchedulerSlotVue2 = {
  ...
  computed: {
    ...
    slotLabel: function slotLabel() {
      return "".concat((0, main_1.formatEventTime)(this.intl, this.$props.zonedStart, this.$props.zonedEnd, this.$props.isAllDay || false));
    }
  },
  inject: {
    kendoIntlService: {
  ...
  render: function render(createElement) {
    ...
    }, [this.intl.formatDate(new Date(this.cSlot.end.getTime() - (this.cSlot.end.getTime() - this.cSlot.start.getTime()) / 2), DAY_FORMAT)]), this.hasMounted && this.itemsPerSlot < this.cSlot.items.length && h(ShowMoreItemsButton_1.ShowMoreItemsButton, {
...
exports.SchedulerSlotVue2 = SchedulerSlotVue2;
/**
 * @hidden
 */
var SchedulerSlot = SchedulerSlotVue2;
exports.SchedulerSlot = SchedulerSlot;