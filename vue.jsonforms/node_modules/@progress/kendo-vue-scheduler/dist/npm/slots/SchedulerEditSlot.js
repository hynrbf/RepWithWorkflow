...
exports.SchedulerEditSlotVue2 = exports.SchedulerEditSlot = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var SchedulerEditSlotVue2 = {
  ...
  computed: {
    ...
    currentTabIndex: function currentTabIndex() {
      var isFirst = this.bv.slots.length && (0, main_1.compareSlots)(this.bv.slots[0].cSlot, this.cSlot);
    ...
    computedEditable: function computedEditable() {
      return (0, main_2.useEditable)(this.$props.editable);
    },
  ...
  methods: {
    ...
    createDataItemFromSlot: function createDataItemFromSlot() {
      var dataItem = {};
      (0, main_1.setField)(dataItem, this.ks.fields.start, new Date(this.cSlot.start.getTime()));
      (0, main_1.setField)(dataItem, this.ks.fields.end, new Date(this.cSlot.end.getTime()));
      (0, main_1.setField)(dataItem, this.ks.fields.isAllDay, this.cSlot.isAllDay);
      if (this.cSlot.group.resources.length) {
        for (var idx = 0; idx < this.cSlot.group.resources.length; idx++) {
          ...
          if ((0, main_1.isGroupped)(this.cSlot.group.resources)) {
            var value = (0, main_1.getField)(this.cSlot.group.resources[idx], resource.valueField);
            (0, main_1.setField)(dataItem, resource.field, resource.multiple ? [value] : value);
          } else {
            (0, main_1.setField)(dataItem, resource.field, resource.multiple ? [] : undefined);
          }
        }
      }
      return dataItem;
      ...
      switch (event.event.keyCode) {
        case kendo_vue_common_1.Keys.left:
          ...
          this.dispatchFocusedSlots({
            type: main_2.SLOTS_FOCUS_ACTION.left,
            slot: this
          }, event.event);
          break;
        case kendo_vue_common_1.Keys.right:
          ...
          event.event.preventDefault();
          this.dispatchFocusedSlots({
            type: main_2.SLOTS_FOCUS_ACTION.right,
            slot: this
          }, event.event);
          break;
        case kendo_vue_common_1.Keys.up:
          ...
          event.event.preventDefault();
          this.dispatchFocusedSlots({
            type: main_2.SLOTS_FOCUS_ACTION.up,
            slot: this
          }, event.event);
          break;
        case kendo_vue_common_1.Keys.down:
          ...
          event.event.preventDefault();
          this.dispatchFocusedSlots({
            type: main_2.SLOTS_FOCUS_ACTION.down,
            slot: this
          }, event.event);
          break;
        ...
        case kendo_vue_common_1.Keys.tab:
          var fi = (0, main_1.findFirstItem)(event.target);
          nextItem = fi ? (0, main_1.findCurrentItem)(fi, this.bv.items, false) : (0, main_1.getSortedSlots)(this.bv.items, this.ignoreIsAllDay)[0];
          this.dispatchFocusedItems({
            type: main_2.ITEMS_FOCUS_ACTION.current,
            item: nextItem
          }, event.event);
          this.dispatchSelectedItems({
            type: main_3.ITEMS_SELECT_ACTION.select,
            item: nextItem
          }, event);
          break;
        default:
...
exports.SchedulerEditSlotVue2 = SchedulerEditSlotVue2;
/**
 * @hidden
 */
var SchedulerEditSlot = SchedulerEditSlotVue2;
exports.SchedulerEditSlot = SchedulerEditSlot;