...
exports.DayViewMiddleRowVue2 = exports.DayViewMiddleRow = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var DayViewMiddleRowVue2 = {
  ...
  render: function render(createElement) {
    ...
    return h("div", {
      "class": (0, kendo_vue_common_1.classNames)('k-scheduler-row', {
      ...
      return h(EditSlot, {
        ...
        attrs: this.v3 ? undefined : {
          ...
          row: this.rootIndex + MultiDayView_1.GRID_OFFSET,
          col: this.timeRanges.length * (this.ri.groupIndex || 0) + slot.range.index,
          isWorkHour: (0, main_1.isInTimeRange)(slot.zonedStart, that.workDayStart, that.workDayEnd),
...
exports.DayViewMiddleRowVue2 = DayViewMiddleRowVue2;
/** @hidden */
var DayViewMiddleRow = DayViewMiddleRowVue2;
exports.DayViewMiddleRow = DayViewMiddleRow;