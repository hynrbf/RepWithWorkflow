...
exports.MultiDayTimelineViewVue2 = exports.MultiDayTimelineView = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var TimelineViewBody_1 = require("./TimelineViewBody");
...
var MultiDayTimelineViewVue2 = {
  ...
  computed: {
    ...
    timelineSlots: function timelineSlots() {
      var _this = this;
      var timelineSlots = (0, slotsService_1.toSlots)(this.ks.dateRange, {
        step: this.slotDuration / this.slotDivisions * kendo_date_math_1.MS_PER_MINUTE
      }, {
        groups: this.ks.groups,
        ranges: this.ranges
      }).filter(function (slot) {
        return (0, main_2.isInTimeRange)(slot.zonedStart, _this.viewStart, _this.viewEnd) || _this.viewStart.getTime() === _this.viewEnd.getTime();
      });
    ...
    items: function items() {
      ...
      var items = (0, itemsService_1.toItems)(this.occurrences, {
        ...
        return _this.viewStart.getTime() === _this.viewEnd.getTime() || (0, main_2.isInTimeRange)(item.zonedStart, _this.viewStart, _this.viewEnd) || (0, main_2.isInTimeRange)(item.zonedEnd, _this.viewStart, _this.viewEnd) || (0, main_2.isInTimeRange)(new Date(item.zonedEnd.getTime() - (item.zonedEnd.getTime() - item.zonedStart.getTime()) / 2), _this.viewStart, _this.viewEnd);
      });
      (0, main_2.mapItemsToSlots)(items, this.timelineSlots, true);
      (0, main_2.mapSlotsToItems)(items, this.timelineSlots, true);
      return items;
    },
  ...
  render: function render(createElement) {
    ...
    var width = (this.ks.orientation === 'horizontal' ? timelineSlots.length : timelineSlots.length / this.ks.groups.length) * (this.$props.columnWidth + main_3.BORDER_WIDTH);
    ...
    var head = [h("div", {
      ...
      return h(DateHeaderCell_1.DateHeaderCell, {
      ...
      h(BaseView_1.BaseView, {
        ...
        h(HorizontalResourceIterator_1.HorizontalResourceIterator, {
          ...
          attrs: _this2.v3 ? undefined : {
            ...
            rowContent: TimelineViewRowContent_1.TimelineViewRowContent
          },
          group: _this2.ks.props.group,
          resources: _this2.ks.props.resources,
          rowContent: TimelineViewRowContent_1.TimelineViewRowContent
        ...
        h(HorizontalResourceIterator_1.HorizontalResourceIterator, {
          ...
          attrs: _this2.v3 ? undefined : {
            group: _this2.ks.props.group,
            resources: _this2.ks.props.resources,
            rowContent: TimelineViewAllEventsRowContent_1.TimelineViewAllEventsRowContent
          },
          resources: _this2.ks.props.resources,
          rowContent: TimelineViewAllEventsRowContent_1.TimelineViewAllEventsRowContent
        }, _this2.v3 ? function () {
          return [
          // @ts-ignore  function children
          h(TimelineViewBody_1.TimelineViewBody, {
        ...
        }), _this2.hasMounted && items.sort(main_2.orderSort).map(function (item) {
          return h(SchedulerEditItem_1.SchedulerEditItem, {
        ...
        return [head];
      } : [head]) : h(VerticalResourceIterator_1.VerticalResourceIterator, {
        wrapGroup: true,
        attrs: _this2.v3 ? undefined : {
          wrapGroup: true,
          group: _this2.ks.props.group,
        ...
        return [h(TimelineViewBody_1.TimelineViewBody, {
          editable: _this2.$props.editable,
          attrs: _this2.v3 ? undefined : {
            editable: _this2.$props.editable,
            slotRender: _this2.$props.slotRender,
...
exports.MultiDayTimelineViewVue2 = MultiDayTimelineViewVue2;
var multiDayTimelineDateRange = function multiDayTimelineDateRange(_a) {
  ...
  var zonedStart = kendo_date_math_1.ZonedDate.fromUTCDate((0, main_2.toUTCDateTime)(firstDay), timezone);
  var zonedEnd = kendo_date_math_1.ZonedDate.fromUTCDate((0, main_2.toUTCDateTime)(lastDay), timezone);
