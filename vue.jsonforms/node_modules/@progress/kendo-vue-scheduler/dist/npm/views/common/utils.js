...
var calculateEventRect = function (slots, vertical) {
    if (slots.length < 1 || !slots[0].refTo || !slots[0].refTo.current) {
        return null;
    }
    var firstSlotRect = (0, exports.getRect)(slots[0].refTo.current.element);
    var rect = {
    ...
    slots.forEach(function (slot) {
        if (!slot.refTo.current) {
            return;
        }
        var height = (0, exports.getRect)(slot.refTo.current.element).height;
        if (height !== undefined) {
