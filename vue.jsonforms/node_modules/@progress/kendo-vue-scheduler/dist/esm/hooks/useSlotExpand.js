import { getPadding, setRect, getRect } from '../views/common/utils.js';
...
export var useSlotExpand = function useSlotExpand(slot, _scheduler, config) {
  ...
  var expand = function expand() {
    ...
    var minHeight = existing.length * BORDER_WIDTH * 2 + highest - (slotPadding || 0) + (isObject(config) && config.offsetTop ? config.offsetTop : 0) + (isObject(config) && config.offsetBottom ? config.offsetBottom : 0);
    if (existing.length) {
