...
import { toGroupResources } from './utils.js';
import { SchedulerResourceIteratorContext } from '../../context/SchedulerResourceIteratorContext.js';
import { getDefaultSlots } from '@progress/kendo-vue-common';
import { DayViewVerticalSlotsRow } from '../day/DayViewVerticalSlotsRow.js';
import { MonthViewBody } from '../month/MonthViewBody.js';
import { TimelineViewBody } from '../time/TimelineViewBody.js';
var FIRST_INDEX = 0;
/** @hidden */
var VerticalResourceIteratorVue2 = {
  ...
  render: function render(createElement) {
    ...
    var renderMore = function renderMore(_resource, currentGroupIndex) {
      return more ? more.timelineSlots ? h(TimelineViewBody, {
        ...
        return h(DayViewVerticalSlotsRow, {
          slotRender: more.slotRender,
          attrs: this.v3 ? undefined : {
            slotRender: more.slotRender,
            viewSlot: more.viewSlot,
    ...
    var renderResourcesRecursively = function renderResourcesRecursively(args, headers) {
      ...
      if (args.depth === args.resources.length || !hasGroups) {
        ...
        } : [getDefaultSlots(that)]), renderMore.call(this, args.resources[args.depth], hasGroups ? args.groupIndex : 0)];
      }
...
export { VerticalResourceIterator, VerticalResourceIteratorVue2 };