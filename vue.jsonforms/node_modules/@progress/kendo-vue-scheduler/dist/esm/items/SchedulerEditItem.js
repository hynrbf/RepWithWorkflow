...
import { SchedulerViewItem } from './SchedulerViewItem.js';
import { ITEMS_FOCUS_ACTION, SLOTS_FOCUS_ACTION } from '../hooks/main.js';
import { FORM_ITEM_ACTION } from './hooks/use-form-item.js';
import { showOccurrenceDialogReducer, SHOW_OCCURRENCE_DIALOG_ACTION } from './hooks/use-show-occurrence-dialog.js';
import { REMOVE_ITEM_ACTION } from './hooks/use-remove-item.js';
import { showRemoveDialogReducer, SHOW_REMOVE_DIALOG_ACTION } from './hooks/use-show-remove-item-dialog.js';
import { DRAG_ITEM_ACTION, useDragItem } from './hooks/use-drag-item.js';
import { RESIZE_ITEM_ACTION, useResizeItem } from './hooks/use-resize-item.js';
import { seriesReducer, SERIES_ACTION } from './hooks/use-series.js';
import { ITEMS_SELECT_ACTION } from '../hooks/use-items-selection.js';
import { compareItems, compareSlots, findMaster } from '../utils/main.js';
/**
 * @hidden
 */
