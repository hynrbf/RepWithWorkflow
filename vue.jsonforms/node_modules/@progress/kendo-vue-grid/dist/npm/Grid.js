...
exports.GridVue2 = exports.Grid = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var GridVue2 = {
  ...
  computed: {
    ...
    currentGroupable: function currentGroupable() {
      return this.$props.groupable === true && this.$props.group && this.$props.group.length || (0, kendo_vue_common_1.isObject)(this.$props.groupable) && this.$props.groupable.enabled !== false;
    },
  ...
  methods: {
    ...
    setRefs: function setRefs() {
      ...
      var groupPanelDiv = (0, kendo_vue_common_1.getRef)(this, 'groupPanelDiv');
      if (groupPanelDiv) {
    ...
    updateGroupCollapsed: function updateGroupCollapsed(event) {
      ...
      var uniqueItemValue = (0, main_1.groupedFirstItemValue)(dataItem || event.dataItem, uniqueField);
      if (event.value) {
    ...
    initColumns: function initColumns(columnElements, groupCount) {
      ...
      this._columns = (0, main_1.readColumns)(columnElements, this.getColumns(), {
        prevId: 0,
        idPrefix: idPrefix
      });
      if (this._columns.length === 0) {
        var currentColumns = (0, main_1.autoGenerateColumns)(this.$props.dataItems, this.$props.group, this.$props.expandField, {
          prevId: 0,
          idPrefix: idPrefix
        });
      ...
      this._columnsMap = (0, main_1.mapColumns)(this._columns);
  ...
  render: function render(createElement) {
    ...
    if (Array.isArray(this.$props.dataItems)) {
      ...
      gridData = (0, main_1.applyExpandedState)(this.$props.dataItems, this.$props.collapsedGroups.length ? this.computedCollapsed : [], this.$props.uniqueField).data;
      total = total || this.$props.dataItems.total;
    }
    var groupable = this.$props.groupable === true || (0, kendo_vue_common_1.isObject)(this.$props.groupable) && this.$props.groupable.enabled !== false;
    ...
    var widthProp = 'width';
    var elementInlineStyleWidth = vnodeDataStyle && (0, kendo_vue_common_1.isObject)(vnodeDataStyle) ? vnodeDataStyle[widthProp] || '' : '';
    ...
    var _a = (0, kendo_vue_data_tools_1.tableColumnsVirtualization)({
      ...
      return {
        row: this._columns.map(function (column, index) {
          ...
          var isCollapsed = this.computedCollapsed && this.computedCollapsed[item.level] && this.computedCollapsed[item.level].some(function (c) {
            return c === (0, main_1.groupedFirstItemValue)(item.dataItem, _this.$props.uniqueField);
          });
          var isExpanded = isCollapsed ? !isCollapsed : item.expanded;
          if (column.internalCell) {
            return h(column.internalCell, {
              key: index,
              id: kendo_vue_data_tools_1.tableKeyboardNavigationTools.generateNavigatableId("".concat(rowId, "-").concat(String(index)), idPrefix),
              attrs: this.v3 ? undefined : {
                id: kendo_vue_data_tools_1.tableKeyboardNavigationTools.generateNavigatableId("".concat(rowId, "-").concat(String(index)), idPrefix),
          ...
          // @ts-ignore
          return h(GridCellValue_1.GridCellValue, {
            dataItem: item.dataItem,
            attrs: this.v3 ? undefined : {
              dataItem: item.dataItem,
              editField: this.$props.editField,
              column: column,
              editCell: h(GridEditCell_1.GridEditCell, {
                id: kendo_vue_data_tools_1.tableKeyboardNavigationTools.generateNavigatableId("".concat(rowId, "-").concat(String(index)), idPrefix),
                attrs: this.v3 ? undefined : {
                  id: kendo_vue_data_tools_1.tableKeyboardNavigationTools.generateNavigatableId("".concat(rowId, "-").concat(String(index)), idPrefix),
                  colSpan: colSpans[index],
              ...
              inbuildCell: h(GridCell_1.GridCell, {
                key: index,
                id: kendo_vue_data_tools_1.tableKeyboardNavigationTools.generateNavigatableId("".concat(rowId, "-").concat(String(index)), idPrefix),
                attrs: this.v3 ? undefined : {
                  id: kendo_vue_data_tools_1.tableKeyboardNavigationTools.generateNavigatableId("".concat(rowId, "-").concat(String(index)), idPrefix),
    ...
    var body = this.currentData.length && this.currentData.map(function (item, rowIndex) {
      ...
      var dataItemKey = this.$props.dataItemKey && (0, kendo_vue_common_1.getter)(this.$props.dataItemKey)(item.dataItem);
      ...
      // @ts-ignore function children
      h(GridDetailHierarchyCell_1.GridDetailHierarchyCell, {
        id: kendo_vue_data_tools_1.tableKeyboardNavigationTools.generateNavigatableId("".concat(detailRowId, "-dhcell"), idPrefix),
        attrs: this.v3 ? undefined : {
          id: kendo_vue_data_tools_1.tableKeyboardNavigationTools.generateNavigatableId("".concat(detailRowId, "-dhcell"), idPrefix)
        }
      }),
      // @ts-ignore function children
      h(GridDetailCell_1.GridDetailCell, {
        dataItem: item.dataItem,
        attrs: this.v3 ? undefined : {
          dataItem: item.dataItem,
          dataIndex: item.dataIndex,
      ...
      h(kendo_vue_data_tools_1.TableKeyboardNavigationProvider, {
        ...
        h(GridNav_1.GridNav, {
          ...
          return [toolbar, groupingPanel, h("div", {
            ...
            ref: (0, kendo_vue_common_1.setRef)(_this3, 'scrollContainer'),
