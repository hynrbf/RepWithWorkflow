...
var bold = toolsSettings_1.EditorToolsSettings.bold,
 ...
 * @hidden
 */
var getShortcuts = function getShortcuts(settings) {
  ...
  var shortcutsSettings = __assign(__assign(__assign(__assign({
    'Mod-b': function ModB(state, dispatch) {
      return (0, kendo_editor_common_1.toggleInlineFormat)(toolsSettings.bold || bold)(state, dispatch);
    },
    'Mod-i': function ModI(state, dispatch) {
      return (0, kendo_editor_common_1.toggleInlineFormat)(toolsSettings.italic || italic)(state, dispatch);
    },
    'Mod-u': function ModU(state, dispatch) {
      return (0, kendo_editor_common_1.toggleInlineFormat)(toolsSettings.underline || underline)(state, dispatch);
    },
    'Mod-z': kendo_editor_common_1.undo,
    'Shift-Mod-z': kendo_editor_common_1.redo
  }, __assign({}, !mac ? {
    'Mod-y': kendo_editor_common_1.redo
  } : {})), {
    'Backspace': kendo_editor_common_1.undoInputRule,
    'Mod-Enter': insertBr,
    ...
    'Tab': (0, kendo_editor_common_1.goToNextCell)(1),
    'Shift-Tab': (0, kendo_editor_common_1.goToNextCell)(-1)
  });
