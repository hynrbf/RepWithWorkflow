...
exports.SelectAllVue2 = exports.SelectAll = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var selectAll = toolsSettings_1.EditorToolsSettings.selectAll;
/**
 * @hidden
 */
var SelectAllVue2 = {
  ...
  methods: {
    handleClick: function handleClick() {
      if (this.view) {
        (0, kendo_editor_common_1.selectAll)(this.view.state, this.view.dispatch);
        this.view.focus();
      }
    },
