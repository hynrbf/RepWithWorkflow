...
exports.UnlinkVue2 = exports.Unlink = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var UnlinkVue2 = {
  ...
  render: function render(createElement) {
    ...
    var hasLink = view ? (0, kendo_editor_common_1.hasMark)(view.state, options) : false;
  ...
  methods: {
    handleClick: function handleClick() {
      ...
      if (view) {
        (0, kendo_editor_common_1.removeLink)(options, view.state.tr.setMeta('commandName', settings.commandName))(view.state, view.dispatch);
      }
    }
  }
};
exports.UnlinkVue2 = UnlinkVue2;
/**
 * @hidden
 */
