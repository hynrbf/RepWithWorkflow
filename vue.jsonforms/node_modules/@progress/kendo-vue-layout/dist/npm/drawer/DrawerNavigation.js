...
exports.DrawerNavigationVue2 = exports.DrawerNavigation = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
  ...
  render: function render(createElement) {
    ...
    var drawerItems = items && h("ul", {
      ...
      if (item && !item.type && !item.render) {
        item = kendo_vue_common_1.templateRendering.call(this, this.$props.item, kendo_vue_common_1.getListeners.call(this));
      }
