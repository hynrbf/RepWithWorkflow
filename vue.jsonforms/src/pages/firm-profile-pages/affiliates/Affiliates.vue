...
export default defineComponent({
  ...
  components: {
    AffiliatesList: defineAsyncComponent(
      () => import("./Partial/AffiliatesList.vue"),
    ),
    AffiliatesCard: defineAsyncComponent(
      () => import("./Partial/AffiliatesCard.vue"),
    ),
    AddAffiliatesModal: defineAsyncComponent(
      () => import("./Partial/AddAffiliatesModal.vue"),
    ),
    ViewAffiliateModal: defineAsyncComponent(
      () => import("./Partial/ViewAffiliateModal.vue"),
    ),
    ViewAffiliatePermissions: defineAsyncComponent(
      () => import("./Partial/ViewAffiliatePermissions.vue"),
    ),
  },
  data() {
    return {
  ...
  created() {
    ...
    this.affiliateList = this.customer.affiliates ?? [];
...
<template src="./affiliates.html" />

<style scoped src="./affiliates.css" />