...
import GridActionButtons from "@/pages/firm-profile-pages/organizational-structure/partials/GridActionButtons.vue";
...
export default defineComponent({
  ...
  components: {
    DynamicAvatar,
    UserDetailAsync: defineAsyncComponent(
      () =>
        import(
          "@/pages/firm-profile-pages/organizational-structure/partials/UserDetail.vue"
        ),
    ),
    TaskDetailsAsync: defineAsyncComponent(
      () =>
        import(
          "@/pages/firm-profile-pages/organizational-structure/partials/TaskDetails.vue"
        ),
    ),
    RoleDetailsAsync: defineAsyncComponent(
      () =>
        import(
          "@/pages/firm-profile-pages/organizational-structure/partials/RoleDetails.vue"
        ),
    ),
    GridActionButtons,
    GridCardTable,
...
<style src="../organizational-structure.css" />
