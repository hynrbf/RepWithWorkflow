...
import RoleDetails from "@/pages/firm-profile-pages/organizational-structure/partials/RoleDetails.vue";
...
<template>
  ...
  <RoleDetails :employee="employee" :dialogWidth="dialogWidth" />
