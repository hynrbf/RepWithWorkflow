...
import { TabHeader } from "@/entities/TabHeader";

export default defineComponent({
  name: "OwnersAndControllers",
  components: {
    CorporateControllerItemComponent: defineAsyncComponent(
      () =>
        import(
          "@/pages/firm-profile-pages/owners-and-controllers/partials/CorporateControllerItemComponent.vue"
        ),
    ),
    IndividualControllerItemComponent: defineAsyncComponent(
      () =>
        import(
          "@/pages/firm-profile-pages/owners-and-controllers/partials/IndividualControllerItemComponent.vue"
        ),
    ),
    IndividualControllerChartModal: defineAsyncComponent(
      () => import("./partials/IndividualControllerChartModal.vue"),
    ),
    CorporateControllerChartModal: defineAsyncComponent(
      () => import("./partials/CorporateControllerChartModal.vue"),
    ),
  },
  data() {
    return {
  ...
  methods: {
    setUniqueIdentifier(value: string): string {
      const identifier = `${AppConstants.ownersAndControllersRoute}${value}`;
...
<template src="./owners-and-controllers.html" />

<style src="./owners-and-controllers.css" />
