...
export default defineComponent({
  name: "IndividualControllerItemComponent",
  components: {
  ...
  methods: {
    ...
    setUniqueIdentifier(value: string): string {
      const identifier = `${AppConstants.ownersAndControllersRoute}-IC${this.identifier}${value}`;
  ...
  >
    ...
    <KendoAccordionItemComponent title="Individual Controller Details">
      <StackLayout orientation="vertical" class="with-vertical-gap">
        ...
        <KendoYesOrNoQuestionInputComponent
          ...
          :id="
            setUniqueIdentifier(
              '-individualControllerDetail.hasBeenSubjectToAnyMaterialComplaints',
            )
          "
          @onValueChange="
            (value: boolean) =>
    ...
    >
      <StackLayout orientation="vertical" class="with-vertical-gap">
        <KendoYesOrNoQuestionInputComponent
          :id="
            setUniqueIdentifier('-individualControllerDetail.hasDirectorship')
          "
