...
const setUniqueIdentifier = (value: string): string => {
  const identifier = `${AppConstants.dataProtectionRoute}-purposeOfDataCollection${value}`;
...
<template>
  <PanelComponent title="Service Dependent Data Collection">
    <template #description>
      Please specify the purposes for which {{ currentFirmName }} collects
      Personal Data which is required for the provision of Services.
    </template>
