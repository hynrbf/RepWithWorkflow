...
const MediaDropdown = defineAsyncComponent(() => import("./MediaDropdown.vue"));
...
const setUniqueIdentifier = (value: string): string => {
  const identifier = `${AppConstants.marketingAndFinancialPromotionsRoute}-promotionTableFilters${value}`;
...
<template>
  <div>
    <MediaDropdown
      :id="setUniqueIdentifier('-platform')"
      name="platform"
      label="Media Outlet"
