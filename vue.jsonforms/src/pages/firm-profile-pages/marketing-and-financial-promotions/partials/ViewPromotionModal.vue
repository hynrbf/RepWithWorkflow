...
import PromotionContent from "./PromotionContent.vue";
import PromotionMedia from "./PromotionMedia.vue";
import PromotionLogs from "./PromotionLogs.vue";
import PromotionCommentInput from "./PromotionCommentInput.vue";
import PromotionDisclosures from "./PromotionDisclosures.vue";
import PromotionDetails from "./PromotionDetails.vue";
import PromotionAttachments from "./PromotionAttachments.vue";
import {
  NotificationType,
  useNotification,
...
const isModirator = computed(
  () => currentCustomer.value.id === promotion.value.moderator
);
          ...
          <PanelComponent class="mb-0 h-100">
            ...
            <PromotionDetails>
              ...
              <template v-if="media" #media-content>
                <PromotionMedia :items="media" />
              </template>
              <template #attachments-content>
                <PromotionAttachments :items="attachments" />
              </template>
            </PromotionDetails>
          </PanelComponent>
        </div>
        <div class="col-lg-6 is-vertical-content gap-4">
          <PanelComponent title="Disclosures" class="mb-0">
            <PromotionDisclosures
              :promotion="promotion"
              :disclosures="currentCustomer.disclosure"
          ...
          >
            <PromotionLogs :promotion="promotion" />
          </PanelComponent>
          <PanelComponent class="mb-0">
            <PromotionCommentInput @submit="submitComment" />
          </PanelComponent>
        </div>
      </div>
    </OverlayLoader>
