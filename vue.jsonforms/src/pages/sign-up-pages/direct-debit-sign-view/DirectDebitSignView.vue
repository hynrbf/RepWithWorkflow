...
export default defineComponent({
  ...
  async created() {
    ...
    this.directDebitMandateUrl = customer.embeddedDirectDebitSigning
      ?.link as string;
  },
  methods: {
...
<template>
  <div class="box">
    <iframe :src="directDebitMandateUrl" width="100%" height="100%" />
  </div>
</template>

<style src="./direct_debit_sign_view.css" scoped />
