...
export default defineComponent({
  name: "EmployeeOrganizationalStructure",
  components: {
    PillComponent,
    MultiSelectTree,
    KendoAutoCompleteInputComponent,
    EmployeeOrganizationalStructureList: defineAsyncComponent(
      () => import("./partials/EmployeeOrganizationalStructureList.vue"),
    ),
    EmployeeOrganizationalStructureCard: defineAsyncComponent(
      () => import("./partials/EmployeeOrganizationalStructureCard.vue"),
    ),
    EmployeeOrganizationalStructureChart: defineAsyncComponent(
      () => import("./partials/EmployeeOrganizationalStructureChart.vue"),
    ),
    EmployeeAddStaffModal: defineAsyncComponent(
      () => import("./partials/EmployeeAddStaffModal.vue"),
    ),
  ...
  computed: {
    ...
    companyNo(): string {
      const cachedCustomer =
        this.appService.getCachedEmployee();
      //TODO. T fix companyNumber and companyNo later
      return cachedCustomer?.companyNumber ?? cachedCustomer?.companyNo ?? "";
    },
  },
  setup() {
  ...
  methods: {
    ...
    setUniqueIdentifier(value: string): string {
      const identifier = `${AppConstants.employeeOrganizationalStructureRoute}${value}`;
...
<template src="./employee-organizational-structure.html" />

<style scoped src="./employee-organizational-structure.css" />