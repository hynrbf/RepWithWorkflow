...
import EmployeeGridActionButtons
  from "@/pages/employee-pages/organizational-structure/partials/EmployeeGridActionButtons.vue";

export default defineComponent({
  name: "OrganizationalStructureList",
  components: {
    DynamicAvatar,
    EmployeeUserDetailAsync: defineAsyncComponent(
      () =>
        import(
          "@/pages/employee-pages/organizational-structure/partials/EmployeeUserDetail.vue"
        ),
    ),
    EmployeeTaskDetailsAsync: defineAsyncComponent(
      () =>
        import(
          "@/pages/employee-pages/organizational-structure/partials/EmployeeTaskDetails.vue"
        ),
    ),
    EmployeeRoleDetailsAsync: defineAsyncComponent(
      () =>
        import(
          "@/pages/employee-pages/organizational-structure/partials/EmployeeRoleDetails.vue"
        ),
    ),
    EmployeeGridActionButtons,
    GridCardTable,
  },
  props: {
    employeesValues: {
...
<style src="../employee-organizational-structure.css" />
