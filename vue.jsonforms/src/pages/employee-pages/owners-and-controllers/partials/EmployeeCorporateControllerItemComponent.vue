...
export default defineComponent({
  name: "EmployeeCorporateControllerItemComponent",
  components: {
    ScrollableTabComponent,
    EmployeeIndividualControllerItemComponent: defineAsyncComponent(
      () => import("./EmployeeIndividualControllerItemComponent.vue"),
    ),
  ...
  methods: {
    ...
    setUniqueIdentifier(value: string): string {
      const identifier = `${AppConstants.employeeOwnersAndControllersRoute}-CC${this.identifier}${value}`;
    ...
    <KendoAccordionItemComponent title="Additional Information">
      <StackLayout class="with-vertical-gap" orientation="vertical">
        <KendoYesOrNoQuestionInputComponent
          ...
          "
          name="corporateControllerDetails.isSubjectToRegulationByAnotherRegulator"
          :isRequired="true"
          :value="
            corporateItem?.corporateController
        ...
        <KendoYesOrNoQuestionInputComponent
          ...
          "
          name="corporateControllerDetails.isThirdCountryFirm"
          numberText="2"
          :isRequired="true"
        ...
        <KendoYesOrNoQuestionInputComponent
          ...
          "
          name="corporateControllerDetails.isMemberOfThirdCountryFinancialConglomerate"
          numberText="4"
          :isRequired="true"
          :value="
            corporateItem?.corporateController
        ...
        <KendoYesOrNoQuestionInputComponent
          ...
          "
          name="corporateControllerDetails.isMemberOfThirdCountryBanking"
          numberText="5"
          :isRequired="true"
          :value="
        ...
        <KendoYesOrNoQuestionInputComponent
          ...
          "
          name="corporateControllerDetails.hasBeenSubjectToAnyMaterialComplaints"
          numberText="6"
          :isRequired="true"
          :value="
            corporateItem.corporateController
        ...
        <template v-slot:IndividualTemplate>
          <StackLayout orientation="vertical" :gap="8">
            ...
            >
              ...
              >
                <Suspense>
                  <EmployeeIndividualControllerItemComponent
                    class="flex-grow-1"
                    :individualItem="
        ...
        <template v-slot:CorporateTemplate>
          <StackLayout orientation="vertical" :gap="8">
            <KendoCard class="mb-4">
              <KendoCardBody>
                <KendoYesOrNoQuestionInputComponent
                  :id="
                    setUniqueIdentifier(
                      '-corporateControllersPage-hasCorporateControllerText',
                    )
                  "
                  :questionText="
            ...
            >
              ...
              >
                <Suspense>
                  <EmployeeCorporateControllerItemComponent
                    class="flex-grow-1"
                    :individualItems="
                      currentIndividualControllerCollapsibleItems
                    "
