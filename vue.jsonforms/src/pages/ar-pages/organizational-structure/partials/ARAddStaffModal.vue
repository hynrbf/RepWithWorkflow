...
import ARFcaRoleHeaderTemplate from "@/pages/ar-pages/organizational-structure/partials/ARFcaRoleHeaderTemplate.vue";
import ARFcaRoleItemTemplate from "@/pages/ar-pages/organizational-structure/partials/ARFcaRoleItemTemplate.vue";
...
export default defineComponent({
  components: {
    DynamicAvatar,
    ARFcaRoleItemTemplate,
    ARFcaRoleHeaderTemplate,
  },
  props: {
    employee: {
  ...
  methods: {
    ...
    setUniqueIdentifier(value: string): string {
      const identifier = `${AppConstants.arOrganizationalStructureRoute}-addStaffModal${value}`;
      ...
      <FormElement ref="formElement">
        <OverlayLoader :loading="saving">
          ...
          <div class="d-flex flex-column" style="gap: 20px">
            ...
            >
              <template #header>
                <ARFcaRoleHeaderTemplate is-multi-select />
              </template>
