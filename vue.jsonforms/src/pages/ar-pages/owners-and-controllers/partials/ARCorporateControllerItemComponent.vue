...
export default defineComponent({
  name: "ARCorporateControllerItemComponent",
  components: {
    ScrollableTabComponent,
    ARIndividualControllerItemComponent: defineAsyncComponent(
      () => import("./ARIndividualControllerItemComponent.vue"),
    ),
  ...
  methods: {
    ...
    setUniqueIdentifier(value: string): string {
      const identifier = `${AppConstants.arOwnersAndControllersRoute}-CC${this.identifier}${value}`;
        ...
        <template v-slot:IndividualTemplate>
          <StackLayout orientation="vertical" :gap="8">
            ...
            >
              ...
              >
                <Suspense>
                  <ARIndividualControllerItemComponent
                    class="flex-grow-1"
                    :individualItem="
        ...
        <template v-slot:CorporateTemplate>
          <StackLayout orientation="vertical" :gap="8">
            ...
            >
              ...
              >
                <Suspense>
                  <ARCorporateControllerItemComponent
                    class="flex-grow-1"
                    :individualItems="
                      currentIndividualControllerCollapsibleItems
                    "
