...
export default defineComponent({ 
  name: "ARViewIntroducerPermissions",
  props: {
    items: {
...
<style scoped>
:global(.ap-modal .k-window-titlebar.k-dialog-titlebar) {
    padding: 15px;
}
...
:global(.ap-modal .k-window-content.k-dialog-content) {
...
:global(.ap-modal .k-dialog-actions.k-actions) {
	padding: 0 0 15px 0;
	margin: 0;
}
</style>