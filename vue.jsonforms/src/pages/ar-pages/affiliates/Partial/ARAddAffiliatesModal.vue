...
export default defineComponent({
  ...
  methods: {
    ...
    setUniqueIdentifier(value: string): string {
      const identifier = `${AppConstants.arAffiliatesRoute}${value}`;
            ...
            <div v-if="isAffiliateMarketingProvider">
              ...
              >
                <KendoFirmFinderComponentAsync
                  :id="setUniqueIdentifier('-affiliateMarketingProvider.firmFinder')"
                  class="flex-grow-1"
                ...
                <KendoPostCodeInputComponent
                  :id="setUniqueIdentifier('-affiliateMarketingProvider.registeredAddress')"
                  class="mt-2"
                  label="Registered Address"
                  @onValueChange="
                    (value: string) =>
                ...
                <KendoPostCodeInputWithSameAsComponent
                  :id="setUniqueIdentifier('-affiliateMarketingProvider.tradingAddress')"
                  label="Trading Address"
                  :isRequired="false"
                  :isUserModified="
                    affiliateInternal?.marketingProviderDetails
                ...
                >
                  <KendoEmailAddressInputComponent
                    :id="setUniqueIdentifier('-affiliateMarketingProvider.emailAddress')"
                    :value="
                  ...
                  <KendoTelInputComponent
                    :id="setUniqueIdentifier('-affiliateMarketingProvider.affiliateContactNumber')"
                    style="margin-left: 15px"
                    label="Contact Number"
                    :value="
                  ...
                  <KendoGenericInputComponent
                    :id="setUniqueIdentifier('-affiliateMarketingProvider.website')"
                    style="margin-left: 15px"
                    class="col"
                    name="website"
                    label="Website (Optional)"
          ...
          <PanelComponent>
            ...
            <div class="d-flex" style="margin-top: 15px">
              <KendoNameTitleComponent
                ...
                :id="setUniqueIdentifier('-affiliate.title')"
                class="col"
                label="Title"
                :is-required="false"
              ...
              <KendoGenericInputComponent
                :id="setUniqueIdentifier('-affiliateMarketingProvider.forename')"
                style="margin-left: 15px"
                class="col"
                name="forename"
                label="Forename(s) "
            ...
            >
              <KendoEmailAddressInputComponent
                :id="setUniqueIdentifier('-affiliateMarketingProvider.values.emailAddress')"
              ...
              <KendoTelInputComponent
                :id="setUniqueIdentifier('-affiliateMarketingProvider.contactNumber')"
                style="margin-left: 15px"
              ...
              <KendoGenericInputComponent
                :id="setUniqueIdentifier('-affiliateMarketingProvider.jobTitle')"
                style="margin-left: 15px"
                class="col"
                name="jobTitle"
